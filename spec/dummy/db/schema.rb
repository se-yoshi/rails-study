...
ActiveRecord::Schema.define(version: 20151031060122) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "access_tickets", force: :cascade do |t|
  ...
  add_index "access_tickets", ["user_id"], name: "index_access_tickets_on_user_id", using: :btree
  ...
  add_index "admins", ["login_name"], name: "index_admins_on_login_name", unique: true, using: :btree
